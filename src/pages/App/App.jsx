  ...
  return (
    <>
      ...
      <nav id="sidebar">
        ...
        <h3 className='mt-1' >{getRandomGreeting()} { user.name }!</h3>
          <img src="/logo.png" alt="Unssung Icon Logo" className="iconLogo" />
        ...
        <ul className="list-group list-group-flush list-unstyled px-2">
          ...
          <br/>
          <li className='list-group-item-dark mb-2'><Link className="custom-hover" to={"/games"}> 
          ...
          <li className='list-group-item-dark mb-2'><Link className="custom-hover" to={"/account"}>
...
&nbsp;&nbsp;
      ...
      <main className='MainApp'>
        <>
            <Routes>
              <Route path="/" element={<AllGamesPage user={user} games={games} setGames={setGames} />} />

              {/* <Route path="/"><Redirect to="/games" /></Route> */}

              <Route path="/games" element={<AllGamesPage user={user} games={games} setGames={setGames} />} /> 
      ...
      <div className="container-fluid">
          ...
          <button type="button" id="sidebarCollapse" className="btn btn-outline-light">
            {/* TOGGLE */}
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="rgb(0, 186, 61)" className="bi bi-list navBarIcons" viewBox="0 0 16 16">
          ...
          <div><Link to={"/account"}>
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="rgb(0, 186, 61)" className="bi bi-person-circle navBarIcons" viewBox="0 0 16 16">
              <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
              <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
            </svg>
          </Link></div>
